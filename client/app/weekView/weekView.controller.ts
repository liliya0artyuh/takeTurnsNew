...
class WeekViewComponent {
   constructor($http, $scope, socket, eventDataContainer, userDataContainer, emailDataContainer) {
            ...
            if (userDataContainer.getUserId()) {
                $http.get('/api/users/' + userDataContainer.getUserId()).then(response => {
